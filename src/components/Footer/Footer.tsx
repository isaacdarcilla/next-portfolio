    ...
    >
      ...
      >
        ...
        <Stack direction='row' spacing={6} ml='auto' mr={{ base: `auto`, md: 5 }}>
          <SocialIcons label='GitHub' href='https://github.com/isaacdarcilla/'>
            <FaGithub />
          </SocialIcons>
          <SocialIcons label='LinkedIn' href='https://www.linkedin.com/in/isaacdarcilla'>
            <FaLinkedin />
          </SocialIcons>

          <SocialIcons label='Facebook' href='https://www.facebook.com/isaacdarcilla/'>
            <FaFacebook />
          </SocialIcons>
